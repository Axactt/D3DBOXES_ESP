...
public:
	...
	bool midDetour( char* lpOriginalFuncAddrs, char* lpFinalHookaddrs )
	{
		...
		ptrdiff_t relAddy = (ptrdiff_t) (lpFinalHookaddrs - lpOriginalFuncAddrs - 5);
		*lpOriginalFuncAddrs = (char) 0xE9;
		*(ptrdiff_t*) (lpOriginalFuncAddrs + 1) = (ptrdiff_t) relAddy;
	...
	char* trampHook( char* lpOriginalFuncAddrs, char* lpFinalHookaddrs )
	{
		...
		ptrdiff_t jumpAddress = (ptrdiff_t) (lpOriginalFuncAddrs - m_gateWay - 5);
		*(m_gateWay + LENGTH) = (char) 0xE9;
		*(ptrdiff_t*) (m_gateWay + LENGTH + 1) = jumpAddress;
